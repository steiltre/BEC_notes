...
%  \div (\eta^2 v) \nonumber \\
%  &\hspace{\smallspace} - 2 \frac{N^2}{M} |v|^2 \div (\eta^2 j) + 2 \frac{N^2}{M} \div \overline{S}_v \cdot j + 2 \frac{N^2}{M} \partial_l (\log \eta^2)
%  (\overline{S}_v)_{lk} j_k + 2 \frac{N^2}{M} \partial_l ( \log \eta^2 ) \overline{R}_{lk} v_k \nonumber \\
%  &\hspace{\smallspace} + \frac{N}{M} v \cdot \nabla ( \log \eta^2 ) \left( \eta^2 | \nabla w |^2 + \frac{\eta^4}{\varepsilon^2} ( 1 - |w|^2 )^2
%  \right) \nonumber \\
